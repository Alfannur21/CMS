...
export const AnimationLoader: React.FC<AnimationLoaderProps> = ({
  ...
  return (
    ...
    >
      <div className="relative z-10 max-w-sm w-full bg-white p-8 rounded-3xl border border-gray-200 shadow-minimal-lg flex flex-col items-center space-y-4">
        ...
        <div className="w-full bg-gray-50/80 p-4 rounded-2xl border border-gray-200/80 my-2">
        ...
        <button
          ...
          className="w-full h-12 px-6 rounded-full bg-gray-900 text-white font-semibold text-sm tracking-wide hover:bg-gray-800 transition-all duration-200 flex items-center justify-center gap-2 shadow-minimal"
        >
